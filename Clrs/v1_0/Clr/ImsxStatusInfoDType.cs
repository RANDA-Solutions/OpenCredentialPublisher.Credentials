...
namespace OpenCredentialPublisher.Credentials.Clrs.v1_0.Clr
{
    ...
    { 
        ...
        [TypeConverter(typeof(CustomEnumConverter<ImsxCodeMajorEnum>))]
        [JsonConverter(typeof(StringEnumConverter<ImsxCodeMajorEnum>))]
        ...
        [TypeConverter(typeof(CustomEnumConverter<ImsxSeverityEnum>))]
        [JsonConverter(typeof(StringEnumConverter<ImsxSeverityEnum>))]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
